                    ...
                    <div id="inner">
                        <div className="grammar">
                            ...
                            <div className="entry" id="pronunciation-writing">
                                ...
                                <p>Trigedasleng doesn't have its own writing system. The bits of writing that have survived the last 97 years are incomplete and have probably been passed down from warrior to warrior along with English. The writers of <i>The 100</i> asked Peterson to use a simplified spelling system for the scripts, instead of using more English-like spelling rules. The table below illustrates this simplified system.</p>
                            ...
                            <div className="entry" id="names">
                                ...
                                <p>Names in Trigedasleng are rendered phonetically, or 'sounded out', based on the system above. Here are a few examples from the show:</p>
                            ...
                            <div className="entry" id="nouns-adjectives">
                                ...
                                <Table striped className="gloss">
                                    <tbody><tr className="tgs_gloss"><td>emo</td><td>hon</td><td>emo</td><td>sobwe</td><td>op</td></tr>
                                        <tr className="leipzig_gloss"><td>3PL</td><td>find</td><td>3PL</td><td>tunnel</td><td>SAT</td></tr>
                                        <tr className="gloss_en"><td colSpan={5}>they find (plural) tunnels</td></tr>
                                    </tbody>
                                </Table>
                            ...
                            <div className="entry" id="demonstratives">
                                ...
                                <p>Trigedasleng enjoys a three-way distinction for demonstrative pronouns, demonstrative adjectives, and spatial adverbs.</p>
                                <Table bordered className="grammar">
                                    <tbody><tr>
                                        <td/>
                                        <th>this-here (1)</th>
                            ...
                            <div className="entry" id="number-system">
                                ...
                                <Table striped size="sm" className="grammar">
                                    <tbody><tr><th colSpan={6}>Ordinal Numbers</th></tr>
                            ...
                            <div className="entry" id="de-particle">
                                ...
                                <Table striped className="gloss">
                                    <tbody><tr className="tgs_gloss"><td>tri-de</td><td>ste</td><td>sen</td><td>yu</td><td>op</td></tr>
                                        <tr className="leipzig_gloss"><td>tree-EM</td><td>be</td><td>hear</td><td>2SG</td><td>SAT</td></tr>
                                        <tr className="en_text"><td colSpan={5}>the trees are listening</td></tr>
                                    </tbody>
                                </Table>
                                <p />
                                <Table striped className="gloss">
                                    <tbody><tr className="tgs_gloss"><td>yu</td><td>laik</td><td>kongeda-de</td></tr>
                                        <tr className="leipzig_gloss"><td>2SG</td><td>be</td><td>alliance-EM</td></tr>
                                        <tr className="en_text"><td colSpan={3}>you are the Alliance</td></tr>
                                    </tbody>
                                </Table>
                                <p />
                                <Table striped className="gloss">
                                    <tbody><tr className="tgs_gloss"><td>oso</td><td>wada</td><td>klin</td><td>laudnes-de</td><td>kom</td><td>fotaim</td></tr>
                                        <tr className="leipzig_gloss"><td>1PL.INCL</td><td>clean</td><td>SAT</td><td>pain-EM</td><td>from</td><td>past</td></tr>
                                        <tr className="en_text"><td colSpan={6}>we cleanse the pain of the past</td></tr>
                                    </tbody>
                                </Table>
                                <p />
                                <Table striped className="gloss">
                                    <tbody><tr className="tgs_gloss"><td>teik</td><td>em</td><td>kamp</td><td>raun</td><td>tribau-de</td></tr>
                                        <tr className="leipzig_gloss"><td>take</td><td>3SG</td><td>stay-near</td><td>SAT</td><td>log-EM</td></tr>
                                        <tr className="en_text"><td>put him on the log</td></tr>
                                    </tbody>
                                </Table>
